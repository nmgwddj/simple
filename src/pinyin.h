...
private:
    ...
    const std::map<std::string, char> tone_to_plain = {
        ...
        {"ě", 'e'}, {"è", 'e'}, {"ế", 'e'}, {"ề", 'e'}, {"ê", 'e'}, {"ō", 'o'},
        {"ó", 'o'}, {"ǒ", 'o'}, {"ò", 'o'}, {"ī", 'i'}, {"í", 'i'}, {"ǐ", 'i'},
        {"ì", 'i'}, {"ū", 'u'}, {"ú", 'u'}, {"ǔ", 'u'}, {"ù", 'u'}, {"ǘ", 'u'},
        {"ǚ", 'u'}, {"ǜ", 'u'}, {"ü", 'u'}, {"ń", 'n'}, {"ň", 'n'}, {"ǹ", 'n'},
        {"ḿ", 'm'},
    };

    const std::set<std::string> pinyin_prefix = {
        "be",   "bia", "ch",   "cho",  "chon", "chua", "co",  "con", "cua",
        "din",  "don", "do",   "dua",  "fe",   "go",   "gon", "ho",  "hon",
        "len",  "lon", "lua",  "mia",  "nia",  "no",   "non", "nua", "pe",
        "pia",  "qio", "qion", "qua",  "ra",   "ro",   "ron", "rua", "sh",
        "sho",  "so",  "son",  "sua",  "ten",  "tia",  "tin", "to",  "ton",
        "tua",  "we",  "xio",  "xion", "xua",  "yon",  "yua", "zh",  "zho",
        "zhon", "zo",  "zon",  "zua",
    };
